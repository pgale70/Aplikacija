...
export class AuthController {
    constructor(
        ...
        @Post('administrator/login') //http://localhost:3000/auth/administrator/login   Request treba da je 'express'
        ...
        @Post('user/login') //http://localhost:3000/auth/user/login   Request treba da je 'express'
